...
<form method="POST" action="{{ route('admin.events.update', $event) }}" id="editEventForm">
@csrf
@method('PUT')
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" name="latitude" id="lat" class="form-control"
                       step="any" value="{{ old('latitude', $event->latitude) }}" required placeholder="-6.988...">
            </div>
            <div class="form-group">
                <label class="form-label">Longitude *</label>
                <input type="number" name="longitude" id="lng" class="form-control"
                       step="any" value="{{ old('longitude', $event->longitude) }}" required placeholder="110.435...">
            </div>
        </div>

        <div class="form-group">
            <label class="form-label">Radius Validasi: <strong id="radiusVal">{{ old('radius', $event->radius) }}</strong> meter</label>
            <input type="range" name="radius" id="radiusSlider" class="radius-slider"
                   min="10" max="500" value="{{ old('radius', $event->radius) }}" style="margin-top:8px;">
            <input type="hidden" name="radius" id="radiusHidden" value="{{ old('radius', $event->radius) }}">
